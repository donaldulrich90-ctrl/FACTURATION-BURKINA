...
const hasAssistantKey = !!(process.env.GROQ_API_KEY || process.env.OPENAI_API_KEY);
if (!hasAssistantKey) {
  console.warn('⚠️  Assistant IA désactivé : ajoutez GROQ_API_KEY ou OPENAI_API_KEY dans server/.env (voir .env.example)');
}
