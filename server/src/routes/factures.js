...
const PREFIXES = { proforma: 'PRO', definitive: 'FAC', bl: 'BL' };
...
router.post('/', authMiddleware, requireRole('company_admin', 'company_user', 'super_admin'), async (req, res) => {
  ...
  const docType = ['proforma', 'definitive', 'bl'].includes(type) ? type : 'proforma';
...
router.patch('/:id', authMiddleware, async (req, res) => {
  ...
  if (canEdit && typeBody && ['proforma', 'definitive', 'bl'].includes(typeBody)) data.type = typeBody;
