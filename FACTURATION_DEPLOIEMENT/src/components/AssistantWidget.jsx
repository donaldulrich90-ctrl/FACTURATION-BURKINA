    ...
    try {
      ...
      if (err?.fallback) {
        setMessages((prev) => [
          ...
          {
            role: 'assistant',
            content: 'L\'assistant IA n\'est pas encore configuré. Ajoutez GROQ_API_KEY=votre_cle dans server/.env (clé gratuite sur console.groq.com). Voir server/.env.example.',
          },
        ]);
      }
    } finally {
